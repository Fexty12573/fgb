...
typedef void (*fgb_instruction_exec_1)(struct fgb_cpu* cpu, const struct fgb_instruction* ins);
typedef void (*fgb_instruction_exec_2)(struct fgb_cpu* cpu, const struct fgb_instruction* ins);
...
void fgb_stop(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_halt(struct fgb_cpu* cpu, const fgb_instruction* ins);

// LD reg16, imm
void fgb_ld_bc_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_de_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_hl_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_sp_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
// LD reg8/(HL), imm
void fgb_ld_b_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_d_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_h_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_c_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_e_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_l_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_p_hl_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
void fgb_ld_p_imm_sp(struct fgb_cpu* cpu, const fgb_instruction* ins);

// JR rel8
void fgb_jr(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jr_nz(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jr_z(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jr_nc(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jr_c(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
// ADD SP, imm
void fgb_add_sp_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
// OP a, imm
void fgb_add_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_adc_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_sub_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_sbc_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_and_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_xor_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_or_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_cp_a_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
// Various LD ...
void fgb_ld_p_imm_a(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_a_p_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
void fgb_ld_p_imm16_a(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_a_p_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_hl_sp_imm(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_ld_sp_hl(struct fgb_cpu* cpu, const fgb_instruction* ins);

// JP [cond], imm16/HL
void fgb_jp_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jp_z_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jp_c_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jp_nz_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jp_nc_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_jp_hl(struct fgb_cpu* cpu, const fgb_instruction* ins);

// CALL [cond], imm16
void fgb_call_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_call_z_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_call_c_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_call_nz_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
void fgb_call_nc_imm16(struct fgb_cpu* cpu, const fgb_instruction* ins);
...
// CB Prefix
void fgb_cb(struct fgb_cpu* cpu, const fgb_instruction* ins);
