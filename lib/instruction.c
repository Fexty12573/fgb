...
const fgb_instruction fgb_instruction_table[FGB_INSTRUCTION_COUNT] = {
    ...
    INS("SUB B", 0x90, 0, 1, fgb_sub_a_b),
    INS("SUB C", 0x91, 0, 1, fgb_sub_a_c),
    INS("SUB D", 0x92, 0, 1, fgb_sub_a_d),
    INS("SUB E", 0x93, 0, 1, fgb_sub_a_e),
    INS("SUB H", 0x94, 0, 1, fgb_sub_a_h),
    INS("SUB L", 0x95, 0, 1, fgb_sub_a_l),
    INS("SUB (HL)", 0x96, 0, 2, fgb_sub_a_p_hl),
    INS("SUB A", 0x97, 0, 1, fgb_sub_a_a),
    INS("SBC A,B", 0x98, 0, 1, fgb_sbc_a_b),
    INS("SBC A,C", 0x99, 0, 1, fgb_sbc_a_c),
    INS("SBC A,D", 0x9A, 0, 1, fgb_sbc_a_d),
    INS("SBC A,E", 0x9B, 0, 1, fgb_sbc_a_e),
    INS("SBC A,H", 0x9C, 0, 1, fgb_sbc_a_h),
    INS("SBC A,L", 0x9D, 0, 1, fgb_sbc_a_l),
    INS("SBC A,(HL)", 0x9E, 0, 2, fgb_sbc_a_p_hl),
    INS("SBC A,A", 0x9F, 0, 1, fgb_sbc_a_a),

    INS("AND B", 0xA0, 0, 1, fgb_and_a_b),
    INS("AND C", 0xA1, 0, 1, fgb_and_a_c),
    INS("AND D", 0xA2, 0, 1, fgb_and_a_d),
    INS("AND E", 0xA3, 0, 1, fgb_and_a_e),
    INS("AND H", 0xA4, 0, 1, fgb_and_a_h),
    INS("AND L", 0xA5, 0, 1, fgb_and_a_l),
    INS("AND (HL)", 0xA6, 0, 2, fgb_and_a_p_hl),
    INS("AND A", 0xA7, 0, 1, fgb_and_a_a),
    INS("XOR B", 0xA8, 0, 1, fgb_xor_a_b),
    INS("XOR C", 0xA9, 0, 1, fgb_xor_a_c),
    INS("XOR D", 0xAA, 0, 1, fgb_xor_a_d),
    INS("XOR E", 0xAB, 0, 1, fgb_xor_a_e),
    INS("XOR H", 0xAC, 0, 1, fgb_xor_a_h),
    INS("XOR L", 0xAD, 0, 1, fgb_xor_a_l),
    INS("XOR (HL)", 0xAE, 0, 2, fgb_xor_a_p_hl),
    INS("XOR A", 0xAF, 0, 1, fgb_xor_a_a),

    INS("OR B", 0xB0, 0, 1, fgb_or_a_b),
    INS("OR C", 0xB1, 0, 1, fgb_or_a_c),
    INS("OR D", 0xB2, 0, 1, fgb_or_a_d),
    INS("OR E", 0xB3, 0, 1, fgb_or_a_e),
    INS("OR H", 0xB4, 0, 1, fgb_or_a_h),
    INS("OR L", 0xB5, 0, 1, fgb_or_a_l),
    INS("OR (HL)", 0xB6, 0, 2, fgb_or_a_p_hl),
    INS("OR A", 0xB7, 0, 1, fgb_or_a_a),
    INS("CP B", 0xB8, 0, 1, fgb_cp_a_b),
    INS("CP C", 0xB9, 0, 1, fgb_cp_a_c),
    INS("CP D", 0xBA, 0, 1, fgb_cp_a_d),
    INS("CP E", 0xBB, 0, 1, fgb_cp_a_e),
    INS("CP H", 0xBC, 0, 1, fgb_cp_a_h),
    INS("CP L", 0xBD, 0, 1, fgb_cp_a_l),
    ...
    INS("CALL NZ,0x%04X", 0xC4, 2, 3, fgb_call_nz_imm16),
    INS("PUSH BC", 0xC5, 0, 4, fgb_push_bc),
    INS("ADD A,0x%02X", 0xC6, 1, 2, fgb_add_a_imm),
    INS("RST 0", 0xC7, 0, 4, fgb_rst_0),
    ...
    INS("RST 2", 0xD7, 0, 4, fgb_rst_2),
    INS("RET C", 0xD8, 0, 2, fgb_ret_c),
    INS("RETI", 0xD9, 0, 4, fgb_reti),
    INS("JP C,0x%04X", 0xDA, 2, 3, fgb_jp_c_imm16),
    INS(NULL, 0xDB, 0, 0, fgb_unimplemented_0),
    INS("CALL C,0x%04X", 0xDC, 2, 3, fgb_call_c_imm16),
    INS(NULL, 0xDD, 0, 0, fgb_unimplemented_0),
    INS("SBC A,0x%02X", 0xDE, 1, 2, fgb_sbc_a_imm),
    INS("RST 3", 0xDF, 0, 4, fgb_rst_3),

    INS("LDH (0x%02X),A", 0xE0, 1, 3, fgb_ld_p_imm_a),
    INS("POP HL", 0xE1, 0, 3, fgb_pop_hl),
    INS("LD (C),A", 0xE2, 0, 2, fgb_ld_p_c_a),
    INS(NULL, 0xE3, 0, 0, fgb_unimplemented_0),
    INS(NULL, 0xE4, 0, 0, fgb_unimplemented_0),
    INS("PUSH HL", 0xE5, 0, 4, fgb_push_hl),
    INS("AND 0x%02X", 0xE6, 1, 2, fgb_and_a_imm),
    INS("RST 4", 0xE7, 0, 4, fgb_rst_4),
    INS("ADD SP,0x%02X", 0xE8, 1, 4, fgb_add_sp_imm),
    INS("JP HL", 0xE9, 0, 1, fgb_jp_hl),
    INS("LD (0x%04X),A", 0xEA, 2, 4, fgb_ld_p_imm16_a),
    INS(NULL, 0xEB, 0, 0, fgb_unimplemented_0),
    INS(NULL, 0xEC, 0, 0, fgb_unimplemented_0),
    INS(NULL, 0xED, 0, 0, fgb_unimplemented_0),
    INS("XOR 0x%02X", 0xEE, 1, 2, fgb_xor_a_imm),
    INS("RST 5", 0xEF, 0, 4, fgb_rst_5),

    INS("LDH A,(0x%02X)", 0xF0, 1, 3, fgb_ld_a_p_imm),
    INS("POP AF", 0xF1, 0, 3, fgb_pop_af),
    INS("LD A,(C)", 0xF2, 0, 2, fgb_ld_a_p_c),
    INS("DI", 0xF3, 0, 0, fgb_di),
    INS(NULL, 0xF4, 0, 0, fgb_unimplemented_0),
    INS("PUSH AF", 0xF5, 0, 4, fgb_push_af),
    INS("OR 0x%02X", 0xF6, 1, 2, fgb_or_a_imm),
    INS("RST 6", 0xF7, 0, 4, fgb_rst_6),
    INS("LD HL,SP+0x%02X", 0xF8, 1, 3, fgb_ld_hl_sp_imm),
    INS("LD SP,HL", 0xF9, 0, 2, fgb_ld_sp_hl),
    INS("LD A,(0x%04X)", 0xFA, 2, 4, fgb_ld_a_p_imm16),
    INS("EI", 0xFB, 0, 1, fgb_ei),
